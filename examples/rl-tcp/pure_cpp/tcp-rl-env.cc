...
TcpTimeStepEnv::TcpTimeStepEnv() : m_agent()
{}
...
void TcpTimeStepEnv::ScheduleNotify()
{
  ...
  std::cerr << "\tstate --"
            ...
            << " cWnd=" << m_tcb->m_cWnd
            << " segmentAcked=" << segmentsAckedSum
            << " segmentSize=" << m_tcb->m_segmentSize
  ...
  if (diff < 500000)   // machine-specific; to remove outliers
  {
...
TcpEventBasedEnv::TcpEventBasedEnv() : m_agent()
{}
